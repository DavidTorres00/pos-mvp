...
class ConfiguracionNegocio(Base):
    ...
    redeploy: límite de efectivo por caja, umbral de stock bajo. No es config de despliegue (eso
    vive en Settings/.env). Sin ningún tope de gasto configurable para pagos a proveedor —
