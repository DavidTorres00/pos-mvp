...
class MovimientoInventario(Base):
    ...
    # snapshot de stock_sucursal.cantidad (para esta sucursal) justo después de aplicar este
    # movimiento — no el stock actual, que cambia con movimientos posteriores; necesario para que
    # el historial sea coherente
